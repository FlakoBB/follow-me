...
const links = linksData.map((link) =>
  SocialLink({
    ...link,
    icon: svgIcons[link.icon]?.({ className: 'linkIcon' }) || `
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="linkIcon">
...
document.querySelector('#app').innerHTML = `
  <section class="main">
    ...
    <div class="user-data">
      ${UserPhoto()}
      <p class="user-name">Joseph Ryan</p>
      <p class="user-description">Hola!</p>
    </div>
    <div class="links">
      ${links}
    </div>
